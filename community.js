...
function toggleTheme() {
  ...
  localStorage.setItem('scnx-theme', state.theme);
...
function onFeedClick(e) {
  ...
  switch (action) {
    ...
    case 'comment':  showToast('Comments coming soon!', 'info', 2000); break;
  }
}
...
function switchSection(section) {
  ...
  const titleMap = {
    ...
    announcements: ['Announcements', 'Official updates from the SciNexus team.'],
...
function init() {
  // Restore theme
  const savedTheme = localStorage.getItem('scnx-theme');
